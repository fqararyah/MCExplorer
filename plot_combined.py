...
plot_exps.plot_boards_models_metric_vs_all_baselines(Metrics.LATENCY,
                                                     ...
                                                     plot_average=True,
                                                     min_y_lim = 0, 
                                                     sub_plot_params = (3, 1, 2),
                                                     custom_dir_postfix='mean',
                                                     file_name='latency.json')
plot_exps.plot_boards_models_metric_vs_all_baselines(Metrics.ENERGY,
                                                     population, generations, sa_tenthousands, hm_max_clusters,
                                                     run_base_anyway=run_base_anyway, plot_ideal=False,
                                                     plot_average=True,
                                                     sub_plot_params = (3, 1, 3),
                                                     min_y_lim = 0,
                                                     custom_dir_postfix='mean',
...
plt.savefig('./boards_normalized_all_metrics_breakdown.png', format='png',
                    bbox_inches='tight')
plt.savefig('./boards_normalized_all_metrics_breakdown.pdf', format='pdf',
            bbox_inches='tight')
plt.clf()
plt.close()